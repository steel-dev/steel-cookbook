...
| Example Name | Languages |
|--------------|-----------|
| <a id="claude-computer-use">Claude Computer Use</a> | [<img src="https://skillicons.dev/icons?i=ts" width="24" height="24">](examples/claude-computer-use-ts) [<img src="https://skillicons.dev/icons?i=python&theme=light" width="24" height="24">](examples/claude-computer-use-py) [<img src="https://skillicons.dev/icons?i=go" width="24" height="24">](examples/claude-computer-use-go) |
