...
|--------------|-----------|
| <a id="playwright">Playwright Integration</a> | [<img src="https://skillicons.dev/icons?i=ts" width="24" height="24">](examples/playwright-ts) [<img src="https://skillicons.dev/icons?i=python&theme=light" width="24" height="24">](examples/playwright-py) [<img src="https://skillicons.dev/icons?i=go" width="24" height="24">](examples/playwright-go) |
...
| Example Name | Languages |
|--------------|-----------|
| <a id="claude-computer-use">Claude Computer Use</a> | [<img src="https://skillicons.dev/icons?i=ts" width="24" height="24">](examples/claude-computer-use-ts) [<img src="https://skillicons.dev/icons?i=python&theme=light" width="24" height="24">](examples/claude-computer-use-py) [<img src="https://skillicons.dev/icons?i=go" width="24" height="24">](examples/claude-computer-use-go) [<img src="https://skillicons.dev/icons?i=rust" width="24" height="24">](examples/claude-computer-use-rs) |
...
| <a id="openai-computer-use">OpenAI Computer Use</a> | [<img src="https://skillicons.dev/icons?i=ts" width="24" height="24">](examples/openai-computer-use-ts) [<img src="https://skillicons.dev/icons?i=python&theme=light" width="24" height="24">](examples/openai-computer-use-py) [<img src="https://skillicons.dev/icons?i=go" width="24" height="24">](examples/openai-computer-use-go) [<img src="https://skillicons.dev/icons?i=rust" width="24" height="24">](examples/openai-computer-use-rs) |
...
| <a id="stripe-projects-web-agent">Stripe Projects Web Agent</a> | [<img src="https://skillicons.dev/icons?i=nextjs" width="24" height="24">](examples/stripe-projects-web-agent) |
...
- [Stripe Projects Web Agent](examples/stripe-projects-web-agent) - Stripe Projects provisions Steel, OpenRouter, and Vercel for a bounded Next.js browser agent with embedded Live View
...
The [Stripe Projects Web Agent](examples/stripe-projects-web-agent) uses the environment contract generated by `stripe projects build`. Its README documents that single setup path instead of manual provider keys.
