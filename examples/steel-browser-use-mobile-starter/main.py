...
https://github.com/steel-dev/steel-cookbook/tree/main/examples/steel-browser-use-mobile-starter
"""
...
async def main():
    ...
    client = Steel(api_key=STEEL_API_KEY)

    try:
        session = client.sessions.create(
            device_config={"device": "mobile"}, solve_captcha=True)
        ...
        try:
            ...
            if session:
                ...
                print(
                    f"Session completed. View replay at {session.session_viewer_url}")
            print("Done!")
