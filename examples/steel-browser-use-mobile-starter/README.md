...
- AI-powered browser interaction using OpenAI GPT-4.1
...
1. **Clone the repository:**
   ...
   cd steel-cookbook/examples/steel-browser-use-mobile-starter
   ```
...
1. **Session Creation**: The script creates a Steel session with mobile mode enabled.
