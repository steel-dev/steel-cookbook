...
[Steel + Eino (Go)](../eino) and [Steel + Pydantic AI (Python)](../pydantic-ai) build the same agent shape in other frameworks. [Genkit Go docs](https://genkit.dev/go/docs/get-started-go) cover tools, flows, and plugins.
