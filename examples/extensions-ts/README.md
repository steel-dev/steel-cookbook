...
[Credentials](../credentials-ts) (persist cookies across runs) · [auth-context](../auth-context-ts) (seed logged-in state) · [profiles](../profiles-ts) (reuse a full browser profile) · [Playwright docs](https://playwright.dev)
